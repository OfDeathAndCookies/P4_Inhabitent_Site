<?php
 /**
 *
 * @package   Inhabitent Site Functionality
 * @author    Jonathan de la Mora <your_email@email.com>
 * @license   GPL-2.0+
 * @copyright 2019 Jonathan de la Mora
 *
 * @wordpress-plugin
 * Plugin Name: [Inhabitent Site] Functionality
